  ...
  return (
    <div className="checkout-graphcool">
      ...
      <div className="content">
        ...
        <div className="right">
          <h3>Semantic Link  Tutorials</h3>
          <Tutorial
            title="Exploring Hypermedia: The Serverless Backend"
            description="Get an overview over all major features of ..."
            link=""
          />
         </div>
      </div>
  ...
  return (
    <a className="tutorial" href={link} target="_blank">
      <style jsx={true}>{`
        ...
        .title {
          @p: .blue, .f16, .flex, .itemsCenter;
        }
        .title::before {
          @p: .ba, .bBlue, .br100, .bw2, .absolute;
          background: $green0;
          left: -30px;
          content: '';
          width: 10px;
